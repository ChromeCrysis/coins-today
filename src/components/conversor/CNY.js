...
export default class CNY extends React.Component {
    ...
    async converter(){
        let moedaB_valor = (parseFloat(this.state.moedaA_valor * this.state.CNY.ask))
                ...
                {CNY ? (
                    <div className="container">
                        <h1>Valor do Yuan Chinês agora: </h1>
                            <div className="row">
                                <div className="col">
                                    <div className="card">
                                        ...
                                        <h3>CNY$: 1.00</h3> <h4> = </h4> <h3>R$: {parseFloat(CNY.ask).toFixed(2)}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h1>Calculadora</h1>
                            <div className="row">
                                <label for="#moedaA">{CNY.code}</label>
                                <div className="col">
                                ...
                                <label for="#moedaB">{CNY.codein}</label>
                                <div className="col">
